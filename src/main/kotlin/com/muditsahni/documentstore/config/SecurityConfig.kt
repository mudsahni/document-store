...
//                    .hasAuthority("SCOPE_${GoogleCredentialsConfig.GOOGLE_CREDENTIALS_SCOPE}")
    ...
    fun apiSecurityFilterChain(http: ServerHttpSecurity): SecurityWebFilterChain {
        ...
        val callbackPattern = PathPatternParserServerWebExchangeMatcher("/api/v1/tenants/*/collections/*/documents/*/process")
        ...
        http
            ...
            .authorizeExchange { auth ->
                auth
                    .pathMatchers("/api/v1/tenants/*/collections/*/documents/*/process").permitAll()
