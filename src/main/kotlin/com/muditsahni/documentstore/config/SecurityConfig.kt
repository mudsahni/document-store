...
class SecurityConfig(
    ...
    fun callbackSecurityFilterChain(http: ServerHttpSecurity): SecurityWebFilterChain {
       return http
            ...
            .securityMatcher(PathPatternParserServerWebExchangeMatcher("/api/v1/tenants/*/collections/*/upload")) // Only for callback endpoints
...
//                    .hasAuthority("SCOPE_${GoogleCredentialsConfig.GOOGLE_CREDENTIALS_SCOPE}")
    ...
    fun apiSecurityFilterChain(http: ServerHttpSecurity): SecurityWebFilterChain {
        ...
        val callbackPattern = PathPatternParserServerWebExchangeMatcher("/api/v1/tenants/*/collections/*/upload")
        ...
        http
            ...
            .authorizeExchange { auth ->
                auth
                    .pathMatchers("/api/v1/tenants/*/collections/*/upload").permitAll()
